...
public final class PlayerBlockBreakTrigger implements Trigger, Listener {
    private final Plugin plugin;
    private final String eventId;
    private final TriggerCallback callback;
    private boolean registered;

    public PlayerBlockBreakTrigger(Plugin plugin, String eventId, TriggerCallback callback) {
